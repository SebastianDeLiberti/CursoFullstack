...
--
-- Servidor: localhost
-- Tiempo de generación: 16-11-2022 a las 16:49:52
...
(16, 'Monica', 'Lanchez', 'Ejecutivo de Ventas', 30, '90000', 'monica@bignet.com'),
...
--
ALTER TABLE `empleados`
  MODIFY `id_emp` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
COMMIT;
